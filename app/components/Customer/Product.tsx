...
const Product = ({ pid }: any) => {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            ...
            if (!res.ok) return;
            setProduct((await res.json()).product);
        };
        fetchProduct();
    }, []);
        ...
        product && (
            <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
                <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
                    ...
                    <div className=" w-full sm:w-96 md:w-8/12  lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
                        <div className=" w-full  bg-gray-100 flex justify-center items-center">
                            <img src={`/images/${product.image}`} alt="Wooden Chair Previw" />
                        </div>
                        {/* <div className=" w-full lg:w-4/12 grid lg:grid-cols-1 sm:grid-cols-4 grid-cols-2 gap-6">
                    <div className="bg-gray-100 flex justify-center items-center py-4">
                        <img src={`/images/${product.image}`} alt="Wooden chair - preview 1" />
                    </div>
                    <div className="bg-gray-100 flex justify-center items-center py-4">
                        <img src={`/images/${product.image}`} alt="Wooden chair - preview 2" />
                    </div>
                    <div className="bg-gray-100 flex justify-center items-center py-4">
                        <img
                ...
                <div
                    ...
                    dangerouslySetInnerHTML={{ __html: mdParser.render(product?.content ?? '') }}
                ></div>
            </div>
        )
    );
